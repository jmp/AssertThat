...
public extension Assertion where Subject: FloatingPoint {
    @discardableResult func isCloseTo(_ expected: Subject, offset: Subject, file: StaticString = #filePath, line: UInt = #line) -> Self {
        XCTAssertEqual(subject, expected, accuracy: offset, file: file, line: line)
        return self
    }

    @discardableResult func isNotCloseTo(_ expected: Subject, offset: Subject, file: StaticString = #filePath, line: UInt = #line) -> Self {
